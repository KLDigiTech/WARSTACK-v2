...
module.exports = {
  ...
  async execute(interaction) {
    ...
    await interaction.reply({
      embeds: [embed],
      components: [new ActionRowBuilder().addComponents(new ButtonBuilder().setLabel('🖥️ Ouvrir le Dashboard').setURL('https://warstack.netlify.app').setStyle(ButtonStyle.Link))],
      ephemeral: true
    });
  }
};