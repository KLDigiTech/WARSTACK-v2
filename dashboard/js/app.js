...
const MODULE_META = {
  welcome     : { icon: '👋', title: 'Accueil des nouveaux membres',   desc: 'Configurez le message de bienvenue envoyé automatiquement quand un membre rejoint votre serveur.', preview: true,  advanced: true  },
  onboarding  : { icon: '📋', title: 'Inscription des membres',        desc: 'Guidez chaque nouveau membre étape par étape jusqu\'à son accès complet au serveur.', preview: false, advanced: true  },
  ...
  tournament  : { icon: '🏆', title: 'Tournois & Compétitions',        desc: 'Créez et gérez des tournois avec inscriptions, résultats et classements automatiques.', preview: true,  advanced: true  },
  ...
  tickets     : { icon: '🎫', title: 'Gestion des demandes',           desc: 'Permettez à vos membres de contacter votre équipe et suivez chaque demande jusqu\'à sa résolution.', preview: false, advanced: true  },
  moderation  : { icon: '🛡️', title: 'Modération & Sanctions',        desc: 'Gérez les avertissements, mutes et bans de vos membres depuis un seul endroit.', preview: false, advanced: true  },
  automod     : { icon: '🤖', title: 'Protection automatique',         desc: 'Détectez et bloquez automatiquement le spam, les liens indésirables et les comportements abusifs.', preview: false, advanced: true  },
  ...
  team        : { icon: '⭐', title: 'Équipe & Permissions',            desc: 'Définissez votre équipe et contrôlez qui peut accéder à chaque section du dashboard.', preview: false, advanced: true  },
  ...
  logs        : { icon: '📋', title: 'Historique des actions',          desc: 'Consultez tout ce qui se passe sur votre serveur : messages, sanctions, connexions.', preview: false, advanced: true  },
  ...
  rulebuilder : { icon: '⚡', title: 'Automatisations',                 desc: 'Créez des règles automatiques : si un événement se produit, WARSTACK agit à votre place.', preview: false, advanced: true  },
...
initDashboard();import { initModal } from './ui/modal.js';
import { $ } from './utils/dom.js';
import { getBotStatus } from './services/botService.js';
import { getUserPermissions } from './services/permissionService.js';
import { loadEmojis, attachEmojiPicker } from './components/emojiPicker.js';
